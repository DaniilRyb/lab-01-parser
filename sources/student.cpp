...
const std::any student_t::GetGroup() const { return group; }
const std::string student_t::GetName() const { return name; }
double student_t::GetAvg() const { return avg; }
const std::any student_t::GetDebt() const { return debt; }
